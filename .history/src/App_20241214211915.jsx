...
function App() {
  ...
  <button
    onClick={toggleMusic}
    className={`bg-transparent font-[font7] writing-vertical-lr text-center hover:text-default border-none shadow-none hover:shadow-none !hover:bg-transparent focus:outline-none ${
