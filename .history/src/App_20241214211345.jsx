...
function App() {
  ...
  return (
    <div className="select-none overflow-hidden">
      ...
      <button
  onClick={toggleMusic}
  className={`bg-transparent font-[font7] text-white border-none shadow-none hover:shadow-none focus:outline-none ${
    isMusicPlaying ? 'bg-green-500 text-black' : 'bg-yellow-500 text-black'
  }`}
>
