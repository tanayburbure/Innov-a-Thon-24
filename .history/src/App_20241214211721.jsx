...
function App() {
  ...
  return (
    <div className="select-none overflow-hidden">
      ...
      <button
  onClick={toggleMusic}
  className={`bg-transparent font-[font7] hover:text-transparent border-none shadow-none hover:shadow-none !hover:bg-transparent focus:outline-none ${
    isMusicPlaying ? 'text-green-500' : 'text-yellow-500'
  }`}
>
