...
const Navbar = () => {
  ...
  return (
    <div className='relative px-4 pt-1 pr-3'>
      ...
      <ul className="flex list-none p-0 m-0 font-bold text-2xl uppercase text-gray-500">
  <MagneticGSAP>
    <li className="mr-4 cursor-pointer hover:text-gray-700 hover:scale-105 transition-transform duration-300">
      <h3 onClick={() => smoothScroll(2.67 * window.innerHeight)}>
        About
      </h3>
    </li>
  </MagneticGSAP>
  <MagneticGSAP>
    <li className="mr-4 cursor-pointer hover:text-gray-700 hover:scale-105 transition-transform duration-300">
      <h3 onClick={() => smoothScroll(1.7 * window.innerHeight)}>
        Prizes
      </h3>
    </li>
  </MagneticGSAP>
  <MagneticGSAP>
    <li className="mr-4 cursor-pointer hover:text-gray-700 hover:scale-105 transition-transform duration-300">
      <h3 onClick={() => smoothScroll(3.52 * window.innerHeight)}>
        Sponsors
      </h3>
    </li>
  </MagneticGSAP>
  <MagneticGSAP>
    <li className="cursor-pointer hover:text-gray-700 hover:scale-105 transition-transform duration-300">
      <h3 onClick={() => smoothScroll(11.67 * window.innerHeight)}>
        FAQ
      </h3>
    </li>
  </MagneticGSAP>
