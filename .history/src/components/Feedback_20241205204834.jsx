            ...
            <div className='w-[40vw]'>
                <form className='space-y-8 text-black '>
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" className='mt-1 py-2 block w-full rounded-md border-gray-300 shadow-sm bg-[#C4DAD2] focus:outline-none focus:ring-indigo-700 focus:border-indigo-500 sm:text-sm pl-2' placeholder='Your Email' />
                    </div>
                    <div>
