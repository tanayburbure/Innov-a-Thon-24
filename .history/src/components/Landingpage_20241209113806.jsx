            ...
            <div className='absolute inset-0 leading-normal flex flex-col '>
                ...
                <style jsx>{`
                  @keyframes glitch {
                    ...
                    10% { text-shadow: 1px 1px 0 rgba(255, 0, 0, 0.5), -1px -1px 0 rgba(0, 255, 0, 0.5); }
                    20% { text-shadow: 0px 0px 0 rgba(255, 0, 0, 0.5), 0px 0px 0 rgba(0, 255, 0, 0.5); }
                    30% { text-shadow: 1px 1px 0 rgba(255, 0, 0, 0.5), -1px -1px 0 rgba(0, 255, 0, 0.5); }
                    40% { text-shadow: 1px 1px 0 rgba(255, 0, 0, 0.5), -1px -1px 0 rgba(0, 255, 0, 0.5); }
                    50% { text-shadow: 0px 0px 0 rgba(255, 0, 0, 0.5), 0px 0px 0 rgba(0, 255, 0, 0.5); }
                    60% { text-shadow: 1px 1px 0 rgba(255, 0, 0, 0.5), -1px -1px 0 rgba(0, 255, 0, 0.5); }
                    70% { text-shadow: 1px 1px 0 rgba(255, 0, 0, 0.5), -1px -1px 0 rgba(0, 255, 0, 0.5); }
                    80% { text-shadow: 0px 0px 0 rgba(255, 0, 0, 0.5), 0px 0px 0 rgba(0, 255, 0, 0.5); }
