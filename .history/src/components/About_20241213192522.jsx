...
function About() {
  ...
  return (
    <div className="text-white h-[80vh] lg:h-[100vh] p-8 mt-24 lg:mt-42 flex flex-col items-center">
      <h1 className="w-[68vw] text-[10vw] lg:text-[7.5vw] mb-4 tracking-light text-center font-[100] text-zinc-400 leading-[3.5vh]">
