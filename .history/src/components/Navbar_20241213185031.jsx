        ...
        <div className="">
          ...
          <ul className={`flex-col md:flex-row md:flex ${menuOpen ? 'flex' : 'hidden'} text-gray-400 font-bold`}>
            {[
              ...
              >
                {item.name}
                <span className="absolute bottom-0 left-1 w-[90%] lg:w-[10%] h-[2px] bg-[#006A67] scale-x-0 origin-left transition-transform duration-400 group-hover:scale-x-100"></span>
              </li>
            ))}
          </ul>
        </div>
