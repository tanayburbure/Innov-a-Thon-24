...
function Footer() {
  return (
    ...
    <div className="h-[200vh] overflow-hidden">
      {/* Divider Line */}
      <div className="h-[1px] bg-zinc-700 mt-12 mx-2"></div>
      ...
      <div className='flex items-center'>
        {/* Socials Section */}
        <div className="">
          <h2 className="text-zinc-400 font-[font15] select-none text-[2.5vh] text-center mb-11">
            SOCIALS
          </h2>
          <div className="flex text-[5vw] gap-8">
            <a
        ...
        {/* Address Section */}
        <div className="">
          <h2 className="font-[font15] text-zinc-400 text-[2.5vh] ">
            ADDRESS
          </h2>
          <div className="text-zinc-400 font-[font6] flex text-[2.5vh] gap-[6px] mb-3">
            <FaMapLocationDot className="mt-[2px] mr-1 text-[#0D7C66]" />
          ...
          <div className="text-zinc-400 font-[font6] flex items-center gap-1">
            <MdEmail className="mt-1 text-[2.5vh] mr-2 text-[#0D7C66]" />
