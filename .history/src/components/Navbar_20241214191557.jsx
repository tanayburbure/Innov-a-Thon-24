...
const Navbar = () => {
  ...
  return (
    <div className="flex w-[70vw] justify-between font-[font1] pt-1 pr-3 lg:px-2">
      ...
      {/* Navigation Links */}
      <div className="relative left-[60vw] lg:left-[62vw] text-[#B3C8CF] tracking-wide z-50 lg:text-[2.4vh] text-[2.2vh] flex justify-end mt-4 lg:mt-5 space-x-8 md:text-[2.2vw] md:pr-[vh]">
        <div>
          <button
