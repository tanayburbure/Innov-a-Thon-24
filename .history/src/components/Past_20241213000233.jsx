...
const Past = () => {
  ...
  return (
    ...
    //   </div>
    // </div>
    <div className="h-[100vh] font-[font1] w-full">
      {/* Left Section */}
      <div className="f">
      ...
      <div className="relative mt-16">
        <div className="flex flex-wrap justify-center items-center">
          {[
            ...
            { top: "12vh", right: "11vh", size: "34%", height: "12vh" },
            { top: "4vh", right: "4vh", size: "38%", height: "13vh" },
            { top: "15vh", left: "15.1vh", size: "34%", height: "auto" },
          ].map((image, index) => (
            <img
              key={index}
              src="public/images/team.png"
