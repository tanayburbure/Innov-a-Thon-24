...
const Navbar = () => {
  ...
  const navItems = [
    {
      name: "About",
      scrollPercentage: isLargeScreen ? 258 : 265,
    },
    {
      name: "Prizes",
      scrollPercentage: isLargeScreen ? 165 : 171,
    },
    {
      name: "Sponsors",
      scrollPercentage: isLargeScreen ? 352 : 353,
    },
    {
      name: "FAQ",
      scrollPercentage: isLargeScreen ? 1100 : 1164,
    },
  ];
