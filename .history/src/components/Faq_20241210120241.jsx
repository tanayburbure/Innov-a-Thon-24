  ...
  return (
    <div className="min-h-[100vh] p-12 pl-[4.9vw] w-full">
      <div className="text-white font-[font1]">
        <h1 className="text-[2.2vw] text-zinc-300 ml-12 font-semibold">
      ...
      <div className="flex text-zinc-400 font-[font6] p-14 gap-8 mt-16 font-light">
        <div className="w-1/2 text-[1.3vw]"> {/* Left Column */}
          {questions.slice(0, 6).map((question, index) => (
            <div key={index} className="mb-6 border-b pb-2 border-gray-500">
              <h2
        ...
        <div className="w-1/2 text-[1.3vw]"> {/* Right Column */}
          {questions.slice(6, 12).map((question, index) => (
            <div key={index + 6} className="mb-6 border-b pb-2 border-gray-500">
              <h2
