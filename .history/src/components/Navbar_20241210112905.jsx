    ...
    <div className='relative px-4 font-[font1] pt-1 pr-3'>
      ...
      <div className='text-[#B3C8CF] tracking-wide  text-[2.2vh] flex justify-end mr-44 pt-1 m-6 space-x-8'>
        ...
        <span className="overflow-hidden whitespace-nowrap">
          <button className='px-3 -mt-[3px] border-none bg-[#41B3A2] ml-4 py-1 pb-[0.5vh] overflow-hidden text-black font-semibold rounded-full z-50 fixed hover:text-white'>
