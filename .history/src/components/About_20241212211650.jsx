...
function About() {
  ...
  return (
    <div className="text-white h-[90vh] p-2 mt-32 flex flex-col items-center">
      ...
      <p
        ref={paragraphRef}
        className="about-content font-[font6] mt-12 text-[1.6vh] text-center  text-zinc-800 leading-[3vh]"
      >
