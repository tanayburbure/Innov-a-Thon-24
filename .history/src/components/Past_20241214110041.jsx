...
const Past = () => {
  ...
  return (
    <div className="h-[110vh] font-[font1] w-full flex flex-col lg:h-[100vh] lg:pl-8">
      {/* Section Title */}
      ...
      <div className="lg:flex lg:justify-between lg:mt-6">
        ...
        <div className="">
          ...
          <p
            ref={paragraphRef}
            className="mt-12 lg:pt-8 w-[85%] font-[font6] text-zinc-800 text-[1.6vh] lg:text-[2.5vh] font-light leading-7 lg:w-[55%] lg:pl-28 "
          >
