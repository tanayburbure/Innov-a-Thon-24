  ...
  return (
    <div className='min-h-[100vh] p-12 pl-[4.9vw] w-full'>
        <div className='text-white font-[font1]'>
            <h1 className='text-[2.2vw] text-zinc-300 ml-12 font-semibold'><span className='text-[#0D7C66] text-[4.4vw]'>FREQUENTLY  </span> Asked Questions</h1>
        </div>
        <div className='flex justify-center align-center text-zinc-400 font-[font6] p-14 gap-8 mt-16 font-light'>
