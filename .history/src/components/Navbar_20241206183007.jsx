...
const Navbar = () => {
  ...
  return (
    <div className='relative px-4 pt-1 pr-8'>
      ...
      <div className='text-white font-[font7] text-[2.2vh] flex justify-end mr-44 pt-1 m-6 space-x-8'>
        ...
        <span className="overflow-hidden whitespace-nowrap">
          <button className='px-2 -mt-[5px] border-2 border-[#0D7C66] ml-4 py-1 pb-[0.5vh] overflow-hidden text-[#219B9D] font-semibold rounded-full z-50 fixed '>
