...
function Sponsors() {
  ...
  return (
    <div className="flex flex-col font-[font1] items-center font-semibold gap-8 justify-start h-[80vh] lg:h-[90vh] w-full text-white">
      {/* Title Section */}
      ...
      <div className="flex flex-wrap justify-center gap-4 mt-8">
        {sponsorImages.map((image, index) => (
          <img
            ...
            className="hover:scale-110 lg:h-[16vh] rounded-lg shadow-md "
          />
        ))}
      </div>
    </div>
