    ...
    <div className='h-[100vh] flex px-20  w-full '>
        ...
        <div className='w-1/2 relative mt-12'>
            <div className='flex flex-wrap justify-center '>
                <img src="public/images/team.png" alt="" className='w-[40%] h-[28vh] border-[1px]  border-[#0D7C66] absolute top-[34vh] -left-1'/>
                <img src="public/images/team.png" alt="" className='w-[34%] h-[24vh] border-[1px]  border-[#0D7C66] absolute top-8 right-16 '/>
                <img src="public/images/team.png" alt="" className='w-[38%] h-[27vh] border-[1px]  border-[#0D7C66] absolute  top-60 right-4'/>
