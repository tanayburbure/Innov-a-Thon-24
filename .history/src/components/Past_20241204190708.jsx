    ...
    <div className='h-[100vh] flex px-20  w-full '>
        ...
        <div className='w-1/2 relative mt-4'>
            <div className='flex flex-wrap justify-center '>
                ...
                <img src="public/images/team.png" alt="" className='w-[45%] h-[27vh] border-[1px]  border-[#0D7C66] absolute  top-60 -right-1'/>
                <img src="public/images/team.png" alt="" className='w-[42%] h-auto border-[1px]  border-[#0D7C66] absolute top-12 left-8'/>
            </div>
        </div>
    </div>
  )
