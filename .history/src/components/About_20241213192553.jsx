...
function About() {
  ...
  return (
    <div className="text-white h-[80vh] lg:h-[100vh] p-8 mt-24 lg:mt-[20vh] flex flex-col items-center">
      ...
      <p
        ref={paragraphRef}
        className="about-content font-[font6] mt-12 text-[1.5vh] text-left  text-zinc-800 leading-[3vh]"
      >
