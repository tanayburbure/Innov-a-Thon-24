    ...
    <div className='relative'>
      ...
      <div className='text-white flex justify-end mr-36 m-4 space-x-8'>
        ...
        <span className="overflow-hidden whitespace-nowrap">
          <button className='px-2 py-1 bg-[#0D7C66] overflow-hidden text-black font-semibold rounded-full z-50 fixed'>
        ...
        <style jsx>{`
          .animate-marquee {
            ...
            animation: marquee 10s linear infinite; /* Increased duration for smoother transition */
          }
