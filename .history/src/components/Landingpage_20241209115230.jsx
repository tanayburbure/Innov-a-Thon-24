    ...
    <div>
        <div className='relative h-[110vh] w-full overflow-hidden'>
            ...
            <div className='absolute inset-0 leading-normal flex flex-col '>
                <Navbar/>
                <h1  className='flex-grow z-[999] tracking-tight mr-4 font-semibold text-[8.4vw] text-center mt-[30vh] text-[#41B3A2] font-[font1] transition-transform opacity-0'>INNOV-A-THON'24 </h1>
