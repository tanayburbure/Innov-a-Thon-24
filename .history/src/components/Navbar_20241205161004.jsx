  ...
  return (
    <div className='relative px-4 pr-8'>
      ...
      <div className='text-white text-lg flex justify-end mr-36 pt-1 m-6 space-x-8'>
        ...
        <h3 className='cursor-pointer' onClick={() => window.scrollTo({ top: 3.4 * window.innerHeight, behavior: 'smooth' })}>Sponsors</h3>
        <h3 className='cursor-pointer' onClick={() => window.scrollTo({ top: 11.65 * window.innerHeight, behavior: 'smooth' })}>FAQ</h3>
