    ...
    <div className='relative px-4 pr-8'>
      ...
      <div className='text-white text-lg flex justify-end mr-36 pt-1 m-6 space-x-8'>
        ...
        <span className="overflow-hidden whitespace-nowrap">
          <button className='px-2 -mt-2 border-2 border-[#0D7C66] ml-4 py-1 pb-[0.8vh] overflow-hidden text-[#219B9D] font-semibold rounded-full z-50 fixed animate-pulse hover:animate-none hover:shadow-lg shadow-md shadow-brown-500'>
