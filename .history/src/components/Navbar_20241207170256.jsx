    ...
    <div className='relative px-4 pt-1 pr-3'>
      ...
      <div className='text-[#B3C8CF] tracking-wide font-[font7] text-[2.2vh] flex justify-end mr-44 pt-1 m-6 space-x-8'>
        ...
        <span className="overflow-hidden whitespace-nowrap">
          <button className='px-2 -mt-[7px] border-2 border-[#0D7C66] ml-4 py-1 pb-[0.5vh] overflow-hidden text-[#B3C8CF] font-semibold rounded-full z-50 fixed '>
            <span className="inline-block animate-marquee font-[font4] bg-[#6A9C89] text-[2.3vh]">Register Here</span>
          </button>
        </span>
        <style jsx>{`
          .animate-marquee {
