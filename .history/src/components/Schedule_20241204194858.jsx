        ...
        <div className="wrapper overflow-x-hidden">
          <div className="flex w-[270vw] h-screen" ref={scrollContainerRef}>
            <div className="w-[200vw] h-screen flex items-center">
              ...
              <div className="absolute  top-[40vh] left-[40vw] transform -translate-x-1/2 flex flex-col items-center">
               
                <div className="flex space-x-8 ml-[100vw] mt-20 gap-[4vw] w-[170vw] ">
                  <div className="text-white text-center">
                    <h3 className="font-semibold">10:00 AM</h3>
                    <p>Opening Ceremony</p>
                    <div className="w-[20vw] h-[20vh] bg-gray-800 rounded-lg shadow-lg mt-2  translate-y-4 transition-opacity duration-500 ease-in-out" >
