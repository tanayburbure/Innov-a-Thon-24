      ...
      <div className='text-[#B3C8CF] tracking-wide font-[font7] text-[2.1vh] flex justify-end mr-44 pt-1 m-6 space-x-8'>
          <ul className="flex text-gray-400 uppercase font-bold ">
            {[
              ...
              <li
                key={index}
                className="relative mt-4 px-4 py-2 cursor-pointer overflow-hidden transition-colors duration-300 hover:text-white group"
              >
                {item}
                <span
                  className="w-full h-[3px] bg-orange-600 scale-x-0 origin-left transition-transform duration-300 group-hover:scale-x-100"
                ></span>
              </li>
            ))}
          </ul>
