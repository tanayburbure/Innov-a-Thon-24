      ...
      <div className="flex flex-col justify-center items-center gap-20">
        ...
        <div className="w-[70vw]">
          <form className="space-y-6">
            {/* Name Field */}
            <div>
              <label htmlFor="name" className="block text-[2vh] font-medium text-gray-600">
                Name
              </label>
              <input
                type="text"
            ...
            {/* Email Field */}
            <div>
              <label htmlFor="email" className="block text-[2vh] font-medium text-gray-600">
                Email
              </label>
              <input
                type="email"
            ...
            {/* Message Field */}
            <div>
              <label htmlFor="message" className="block text-[2vh] font-medium text-gray-600">
                Message
              </label>
              <textarea
                id="message"
