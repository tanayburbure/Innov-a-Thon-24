  ...
  return (
    <div>
      <div className="relative h-[110vh] w-full overflow-hidden">
        ...
        <video
          ref={videoRef}
          className="h-full w-full object-cover brightness-[40%] sm:w-28"
          autoPlay
          muted
        ...
        <div className="absolute inset-0 flex flex-col leading-normal">
          ...
          {/* Main Heading */}
          <h1 className="flex-grow tracking-tight font-semibold text-[8.4vw] text-center mt-[17vh] text-[#0D7C66] font-[font1] transition-transform sm:font-bold">
            INNOV-A-THON'24
          </h1>
