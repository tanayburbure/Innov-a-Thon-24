...
import Magnet from './MagneticGSAP';
  ...
  return (
    <div className='relative px-4 pt-1 pr-3'>
      ...
      <div className='text-[#B3C8CF] tracking-wide font-[font7] text-[2.2vh] flex justify-end mr-44 pt-1 m-6 space-x-8'>
        <MagneticGSAP>
        <h3 className='cursor-pointer' onClick={() => smoothScroll(2.67 * window.innerHeight)}>About</h3>
        </MagneticGSAP>
        <h3 className='cursor-pointer' onClick={() => smoothScroll(1.7 * window.innerHeight)}>Prizes</h3>
        <h3 className='cursor-pointer' onClick={() => smoothScroll(3.52 * window.innerHeight)}>Sponsors</h3>
        <h3 className='cursor-pointer' onClick={() => smoothScroll(11.67 * window.innerHeight)}>FAQ</h3>
