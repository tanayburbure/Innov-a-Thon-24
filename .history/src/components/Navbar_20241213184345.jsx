  ...
  return (
    ...
    <div className="flex w-[70vw] justify-between font-[font1] pt-1 pr-3">
      ...
      <div className="p-2 lg:p-4 fixed z-50">
        <img className="w-[9vw] lg:w-[5vw]" src="public/images/lobo.png" alt="Logo" />
      </div>

      {/* Navigation Links */}
      <div className="relative left-[60vw] text-[#B3C8CF] tracking-wide z-50 text-[2.2vh] flex justify-end mt-4 space-x-8">
        <div className="">
        ...
        <span className="relative top-4 -right-8 whitespace-nowrap lg:left-[20vw] lg:">
          <button className="border-none bg-[#41B3A2] overflow-hidden pb-[0.5vh] text-black font-semibold rounded-full z-[99999] fixed">
            <span className="inline-block animate-marquee font-[font4] text-[1.6vh] lg:text-[2.2vh] lg:px-4 lg:pt-[2.5px]">
              Register Here
            </span>
          </button>
        </span>
