...
function About() {
  ...
  return (
    <div className="text-white h-[80vh] lg:h-[100vh] p-8 mt-24 lg:mt-[30vh] flex flex-col items-center">
      <h1 className="w-[68vw] text-[10vw] lg:text-[8vw] mb-4 tracking-light text-center font-[100] text-zinc-400 leading-[3.5vh]">
      ...
      <p
        ref={paragraphRef}
        className="about-content lg:w-[70%] font-[font6] mt-12 text-[1.5vh] lg:mt-28 lg:text-[1.4vw] text-left
        lg:text-center  text-zinc-800 leading-[3vh] lg:leading-[3.5vh]"
      >
