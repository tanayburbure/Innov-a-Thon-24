...
function Footer() {
  return (
    <div className=" h-[32vw] w-full overflow-hidden">
      ...
      <div className='flex justify-between align-center font-[font1] text-zinc-600 px-16'>
        <h3 className='font-[font1]'>All Rights Reserved © 2024</h3>
        <h3>contact developer</h3>
        <h3 className='font-[font1]'>WEBSITE BY TESA TECH TEAM</h3>
      </div>
    </div>
  )
}
