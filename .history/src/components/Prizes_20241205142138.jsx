  ...
  return (
    <div className='h-[100vh] mt-[28vw] flex text-white items-center flex-col w-full'>
        ...
        <div className='flex justify-between items-center mt-20 w-full'>
          <video className='h-[10vh] w-auto' controls>
            <source src="public/videos/side_video_1.mp4" type="video/mp4" />
          ...
          <video className='h-[10vh] w-auto' controls>
            <source src="public/videos/side_video_2.mp4" type="video/mp4" />
            Your browser does not support the video tag.
          </video>
        </div>
    </div>
