    ...
    <div className='h-[88vh] font-[font1] flex px-16  w-full '>
        <div className='relative w-1/2'>
            ...
            <div className='relative pl-16 py-2'>
                ...
                <p className='mt-4 w-[85%] font-[font3] text-zinc-300 text-[2.3vh] font-[300] leading-7'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa, in distinctio! Incidunt tempore nihil nostrum obcaecati temporibus sed tempora porro unde, aperiam suscipit. Eligendi repellat mollitia voluptates fugit dicta blanditiis tempore! Reiciendis, rem vel eveniet sunt natus porro.
                   Vero vel consequuntur eligendi sit quibusdam eum atque architecto repellendus tempora. Sequi ullam excepturi placeat sunt minus tempore voluptas reprehenderit incidunt, illum tempora dolores corrupti cumque quas! Fugit animi numquam autem? Fugiat perferendis iure, quia.</p>
            </div>
        </div>
        <div className='w-1/2 relative mt-16'>
            <div className='flex flex-wrap justify-center '>
                <img src="public/images/team.png" alt="" className='w-[40%] h-[24vh] border-[1px]  border-[#0D7C66] absolute top-[28vh] left-16'/>
                <img src="public/images/team.png" alt="" className='w-[34%] h-[21vh] border-[1px]  border-[#0D7C66] absolute top-16 right-24 '/>
                <img src="public/images/team.png" alt="" className='w-[38%] h-[24vh] border-[1px]  border-[#0D7C66] absolute  top-60 right-20'/>
                <img src="public/images/team.png" alt="" className='w-[34%] h-auto border-[1px]  border-[#0D7C66] absolute top-12 left-28'/>
            </div>
        </div>
    </div>
  )
