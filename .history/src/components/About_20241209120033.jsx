...
function About() {
  ...
  return (
    <div className='text-white h-[78vh] mt-20 -mb-8 flex flex-col justify-center items-center '>
      <h3 ref={venueRef} className='absolute top-[57vw] text-center leading-[3.5vw] text-[#B3C8CF] text-[3.7vh] font-[font7] w-[72vw]'>
        <div><Card /> </div>
        <br />
        VENUE:
        <br />
      ...
      <h2 ref={headingRef} className='w-[68vw] mb-20 font-regular font-[font6] tracking-light text-center text-[2.5vh] font-[100] text-zinc-400 leading-[3.5vh]'>
