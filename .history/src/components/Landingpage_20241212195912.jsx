    ...
    <div>
      <div className="relative h-[110vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col leading-normal">
          ...
          <div className='mt-8'>
            {/* Main Heading */}
          <h1 className="flex-grow  tracking-tight font-semibold text-[15.5vw] text-center mt-[17vh] text-[#0D7C66] font-[font1] transition-transform sm:text-[6vw]">
            INNOV-A-THON
            <br />
            '2024
          </h1>
          ...
          {/* Tagline */}
          <h4 className="text-transparent absolute top-[56vh] pl-8 text-[2vh] font-light tracking-tight text-center bg-gradient-to-r from-[#0D7C66] to-green-300 bg-clip-text font-[font1]">
