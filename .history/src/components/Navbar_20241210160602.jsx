  ...
  return (
    <div className="relative px-4 font-[font1] pt-1 pr-3">
      ...
      <div className="p-4 fixed z-50">
        <img className="w-[10vw] md:w-[4vw]" src="public/images/lobo.png" alt="Logo" />
      </div>

      {/* Navigation Links */}
      <div className="text-[#B3C8CF] tracking-wide text-[2.5vh] md:text-[2.2vh] flex justify-end md:mr-44 pt-1 m-6 space-x-4 md:space-x-8">
        <ul className="flex text-gray-400 font-bold">
          {[
            ...
            <li
              key={index}
              className="relative px-2 md:px-4 py-2 -mt-2 cursor-pointer overflow-hidden transition-colors duration-300 hover:text-white group"
        ...
        <span className="whitespace-nowrap">
          <button className="px-2 md:px-3 -mt-[3px] overflow-hidden border-none bg-[#41B3A2] ml-2 md:ml-4 py-1 pb-[0.5vh] text-black font-semibold rounded-full z-50 fixed">
            <span className="inline-block animate-marquee font-[font4] text-[2.5vh] md:text-[2.3vh]">
              Register Here
            </span>
          </button>
        </span>
