...
function Prizes() {
  return (
    <div className='h-[100vh] mt-[30vw] flex text-white items-center flex-col w-full'>
        <h1 className='text-[8vw] font-[font112] text-zinc-400 text-center pr-2 tracking-tighter font-semibold'>Exciting <span className='text-[#0D7C66]'>Prizes</span></h1>
