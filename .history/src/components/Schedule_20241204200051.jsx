...
const Schedule = () => {
  ...
  useEffect(() => {
    ...
    cards.forEach((card, index) => {
      gsap.fromTo(card, { opacity: 0, y: 50 }, { // Start with opacity 0 and translate in y direction
        opacity: 1,
            ...
            <div className="flex space-x-8 ml-[100vw] mt-20 gap-[4vw] w-[170vw] ">
              {[
                ...
                <div className="text-white text-center" key={index}>
                  ...
                  <p>{event.title}</p>
                  <div className={`card w-[20vw] h-[20vh] bg-gray-800 rounded-lg shadow-lg mt-2 opacity-0 translate-y-4 transition-opacity duration-500 ease-in-out`}>
