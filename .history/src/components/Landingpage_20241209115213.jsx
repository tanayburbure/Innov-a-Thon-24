...
export const Landingpage = () => {
  ...
  useEffect(() => {
    ...
    gsap.from(titleRef.current, { duration: 0.4, y: -100, opacity: 0, ease: "power2.out" });
    ...
    <div>
        <div className='relative h-[110vh] w-full overflow-hidden'>
            ...
            <div className='absolute inset-0 leading-normal flex flex-col '>
                <Navbar/>
                <h1 ref={titleRef} className='flex-grow z-[999] tracking-tight mr-4 font-semibold text-[8.4vw] text-center mt-[30vh] text-[#41B3A2] font-[font1] transition-transform opacity-0'>INNOV-A-THON'24 </h1>
                <h4 ref={subtitleRef} className='text-transparent text-[2.8vh] font-light tracking-tight  text-center ml-[40vw] -mb-[10vh] bg-gradient-to-r from-green-900 to-green-100 bg-clip-text font-[font11] opacity-0'>Igniting Innovation, Fueling the Future</h4>
