  ...
  return (
    ...
    <div className="h-[78vh] lg:h-[50vh] overflow-hidden">
      ...
      <div>
        ...
        <div className="flex items-center justify-between font-[font1] text-[2.1vw] lg:text-[2vw] text-zinc-600  lg:flex-row lg:justify-between lg:items-center lg:px-16 px-2">
