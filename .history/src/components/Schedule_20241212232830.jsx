...
const Schedule = () => {
  ...
  return (
    ...
    // </div>
    <div className="wrapper overflow-x-hidden">
      <div className="flex w-[270vw] h-[500vh]" ref={scrollContainerRef}>
        <div className="w-[100vw] h-screen flex items-center justify-center">
          ...
          <div className="absolute mt-[100vh] flex flex-col items-center">
            <div className=" mt-[7vh]">
              {[
                ...
                <div className="text-white text-center mt-12" key={index}>
                  <h3 className="font-semibold mb-8 text-xl mt-8">{event.time}</h3>
