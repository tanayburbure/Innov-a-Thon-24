...
const Past = () => {
  ...
  return (
    ...
    <div className="h-[110vh] font-[font1] w-full flex flex-col ">
      {/* Section Title */}
      <h1 className="text-[10.5vw] text-zinc-400 font-semibold pl-[25vw] lg:text-[8vw] lg:pl-[40vw]">
      ...
      <div className="f">
        <div className="flex flex-col items-center">
          ...
          <p
            ref={paragraphRef}
            className="mt-12 w-[85%] font-[font6] text-zinc-800 text-[1.6vh] font-light leading-7"
          >
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa, in distinctio! Incidunt
            tempore nihil nostrum obcaecati temporibus sed tempora porro unde, aperiam suscipit.
            Eligendi repellat mollitia voluptates fugit dicta blanditiis tempore! Reiciendis, rem
      ...
      <div className="relative mt-16">
        <div className="flex flex-wrap justify-center items-center">
          {[
            { top: "2vh", left: "7vw", size: "40%", height: "13vh" },
            { top: "16vh", right: "6vh", size: "34%", height: "12vh" },
            { top: "3vh", right: "4vh", size: "38%", height: "11vh" },
            { top: "17vh", left: "6vh", size: "34%", height: "auto" },
          ].map((image, index) => (
            <img
              key={index}
              src="public/images/team.png"
