    ...
    <div>
      <div className="relative h-[100vh] w-full overflow-hidden lg:h-[110vh]">
        ...
        <div className="absolute inset-0 flex flex-col leading-normal">
          ...
          {/* Tagline */}
          <h4 className="text-transparent absolute top-[43vh] pl-8 text-[1.8vh] font-light tracking-tight text-center bg-gradient-to-r from-[#0D7C66] to-green-300 bg-clip-text font-[font1] lg:text-[3vh] lg:right-[15%] lg:top-[45%]">
