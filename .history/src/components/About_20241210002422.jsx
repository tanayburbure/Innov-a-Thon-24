...
function About() {
  ...
  return (
    <div className='h-[70vh] mt-48 flex flex-col items-center'>
      <h1
        ref={headingRef}
        className='w-[68vw] mb-4 gap-20 tracking-light font-[font1] text-[7.5vw] text-center font-[700] text-zinc-400 leading-[3.5vh]'
      >
        About <span className='text-[#0D7C66] tracking-tighter m-12'>Us</span>
      </h1>
      <p
        ref={paragraphRef}
