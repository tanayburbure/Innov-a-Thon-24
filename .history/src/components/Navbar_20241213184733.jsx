...
const Navbar = () => {
  ...
  return (
    ...
    <div className="flex w-[70vw] justify-between font-[font1] pt-1 pr-3">
      ...
      {/* Navigation Links */}
      <div className="relative left-[60vw]  text-[#B3C8CF] tracking-wide z-50 text-[2.2vh] flex justify-end mt-4 lg:mt-5 space-x-8">
        <div className="">
          <button className="text-gray-400 fixed border-none font-bold md:hidden" onClick={() => setMenuOpen(!menuOpen)}>
