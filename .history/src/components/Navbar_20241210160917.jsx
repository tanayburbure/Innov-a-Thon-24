...
const Navbar = () => {
  ...
  return (
    <div className="relative px-4 font-[font1] pt-1 pr-3">
      ...
      {/* Navigation Links */}
      <div className={`text-[#B3C8CF] tracking-wide text-[2.2vh] flex flex-col md:flex-row justify-end mr-44 pt-1 m-6 space-y-4 md:space-y-0 md:space-x-8 ${menuOpen ? 'block' : 'hidden'} md:block`}>
        ...
        <span className="whitespace-nowrap">
          <button className="px-3 mt-2 md:mt-0 overflow-hidden border-none bg-[#41B3A2] py-1 pb-[0.5vh] text-black font-semibold rounded-full z-50">
