    ...
    <div className='h-[100vh] flex px-20  w-full '>
        ...
        <div className='w-1/2 relative mt-4'>
            <div className='flex flex-wrap justify-center '>
                <img src="public/images/team.png" alt="" className='w-[50%] h-[28vh] border-[1px]  border-[#0D7C66] absolute top-[34vh] -left-1'/>
                <img src="public/images/team.png" alt="" className='w-[40%] h-[24vh] border-[1px]  border-[#0D7C66] absolute top-8 right-12 '/>
                <img src="public/images/team.png" alt="" className='w-[45%] h-[27vh] border-[1px]  border-[#0D7C66] absolute  top-64 -right-1'/>
                <img src="public/images/team.png" alt="" className='w-[42%] h-auto border-[1px]  border-[#0D7C66] absolute top-12 left-12'/>
            </div>
        </div>
    </div>
  )
