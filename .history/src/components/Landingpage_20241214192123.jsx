    ...
    <div>
      <div className="relative h-[100vh] w-full overflow-hidden lg:h-[110vh]">
        ...
        <div className="absolute inset-0 flex flex-col leading-normal">
          ...
          <div className='mt-8'>
            {/* Main Heading */}
          <h1 className="absolute top-[33vh] flex-grow tracking-tight font-semibold text-[13vw] text-center text-[#0D7C66] font-[font1]  lg:text-[8.5vw] lg:right-[15%] lg:top-[25%] md:right-[0] md:text-[12.79vw]">
            INNOV-A-THON'24
          </h1>
