...
const Navbar = () => {
  ...
  return (
    <div className="relative px-4 font-[font1] pt-1 pr-3 bg-[#00FF00]">
      {/* Logo */}
      <div className="p-4 relative z-50 flex justify-center">
        <img className="w-[4vw]" src="public/images/lobo.png" alt="Logo" />
      </div>

      {/* Menu Button for Mobile */}
      <div className="relative top-4 right-4 z-50 md:hidden flex justify-center">
        <button
          onClick={() => setIsMenuOpen(!isMenuOpen)}
          className="text-white bg-[#00FF00] p-2 rounded flex items-center"
        >
      ...
      <div
        ...
        } md:flex text-[#B3C8CF] tracking-wide text-[2.2vh] justify-center pt-1 m-6 space-x-8`}
      >
