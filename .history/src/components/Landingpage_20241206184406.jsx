    ...
    <div>
        <div className='relative h-[100vh] w-full overflow-hidden'>
            ...
            <div className='absolute inset-0 leading-normal flex flex-col '>
                <Navbar/>
                <h1 className='flex-grow tracking-wide mr-4 font-semibold text-[8vw] text-center mt-[17vh] bg-[#02a987] to-green-100 text-transparent bg-clip-text font-[font7]'>Innov-a-Thon'24 </h1>
