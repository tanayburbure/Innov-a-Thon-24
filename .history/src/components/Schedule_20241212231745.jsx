  ...
  return (
    ...
    <div className="wrapper overflow-x-hidden">
      <div className="flex w-[270vw] h-[500vh]" ref={scrollContainerRef}>
        <div className="w-[200vw] h-screen flex items-center">
          <h1 className="absolute text-transparent bg-clip-text bg-gradient-to-t from-[#09a082] to-[#0D7C66] top-12 flex text-[7.5vw] -tracking-[2px] font-[font1] font-[600] mb-[2vh]">
            SCHEDULE
          </h1>
          <div className="absolute top-[38vh] left-[42vw] transform -translate-x-1/2 flex flex-col items-center">
