        ...
        <div className="relative top-[9.8vh] left-[12vw] ">
          ...
          <div className="flex text-[1.6vw] text-white gap-8">
            <a
              ...
              href="">
              <span className="absolute top-0 left-0 w-full h-full bg-[#0D7C66] opacity-0 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-[-100%]"></span>
