...
function About() {
  ...
  return (
    <div className='text-white h-[78vh] mt-20 -mb-8 flex flex-col items-center'>
      <h2 className='about-title w-[68vw] mb-4 font-regular font-[font6] tracking-light text-center text-[2.5vh] font-[100] text-zinc-400 leading-[3.5vh]'>
      ...
      <p className='about-content w-[68vw] mt-20 text-center text-zinc-400 leading-[3.5vh]'>
