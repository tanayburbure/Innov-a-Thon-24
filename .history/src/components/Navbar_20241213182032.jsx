...
const Navbar = () => {
  ...
  return (
    ...
    //   `}</style>
    // </div>
    <div className="flex w-screen items-center justify-between font-[font1] pt-1 pr-3">
      {/* Logo */}
      <div className="p-4 fixed z-50">
        <img className="w-[4vw]" src="public/images/lobo.png" alt="Logo" />
      </div>
      ...
      {/* Navigation Links */}
      <div className="relative  text-[#B3C8CF] tracking-wide z-50 text-[2.2vh] flex justify-end  pt-1 m-6 space-x-8">
        <div className="">
