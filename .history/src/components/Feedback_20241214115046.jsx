...
function Feedback() {
  return (
    ...
    //   </div>
    // </div>
    <div className="h-[60vh] mt-16 text-white font-[font6] lg:h-[80vh] lg:mt-0 lg:pb-[10vh]">
      <div className="flex flex-col justify-center items-center gap-20 ">
        <h2 className="text-[7vw] lg:text-[2.7vw] lg:pl-[4vw] font-bold mt-4 bg-gradient-to-r from-[#0D7C66] to-[#27DFB3] bg-clip-text text-transparent lg:w-[50%]">
          Send a Message
        </h2>
