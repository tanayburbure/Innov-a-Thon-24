    ...
    <div className=" h-[32vw] w-full overflow-hidden">
      ...
      <div className="flex py-[3vh]">
        <div className="px-24 py-[10vh] text-zinc-400 select-none">
          <img className="h-[10vw] mb-2 pl-[3.5vh] select-none transition-transform duration-300 hover:scale-105" src="public\images\lobo.png" alt="" />
        ...
        <div className="relative top-[9.8vh] left-[12vw] ">
          ...
          <div className="flex text-[1.5vw] font-bolder gap-8">
          <a
              className="relative p-8 border-[1px] border-[#2A2929] rounded-full bg-[#2A2929] text-white overflow-hidden transition-all duration-300 group"
              href="">
              <IoLogoInstagram className="relative z-10 group-hover:font-bold group-hover:text-[2rem]" />
            ...
            <a
              className="relative p-8 border-[1px] border-[#2A2929] rounded-full bg-[#2A2929] text-white overflow-hidden transition-all duration-300 group"
              href="">
              <FaLinkedinIn className="relative z-10 group-hover:font-bold group-hover:text-[2rem]" />
            ...
            <a
              className="relative p-8 border-[1px] border-[#2A2929] rounded-full bg-[#2A2929] text-white overflow-hidden transition-all duration-300 group"
              href="">
              <FaDiscord className="relative z-10 group-hover:font-bold group-hover:text-[2rem]" />
        ...
        <div className="relative w-[25vw]  left-[28vw] top-[9.6vh]">
          ...
          <div className="text-zinc-400 font-semibold font-[font6] flex text-[2.8vh] gap-[6px] mb-3 ">
          ...
          <div className="text-zinc-400 font-semibold font-[font6] flex items-center gap-1">
