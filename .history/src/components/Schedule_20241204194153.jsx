            ...
            <div className="w-[200vw] h-screen flex items-center">
              ...
              <div className="absolute  top-[40vh] left-[50vw] transform -translate-x-1/2 flex flex-col items-center">
                ...
                <div className="flex space-x-8 ml-[100vw] mt-20 gap-[4vw] w-[170vw] ">
                  <div className="bg-gray-800 rounded-lg p-4 shadow-lg transform transition-transform duration-300 ease-in-out hover:scale-105">
                    <h3 className="font-semibold text-lg">10:00 AM</h3>
                    <p className="text-sm">Opening Ceremony</p>
                  </div>
