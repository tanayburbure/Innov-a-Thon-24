...
function About() {
  ...
  return (
    <div className="text-white h-[90vh] w-[90vw] mt-32 flex flex-col items-center">
      <h1 className="w-[68vw] text-[10vw] pl-[10vw] mb-4 tracking-light text-center font-[100] text-zinc-400 leading-[3.5vh]">
      ...
      <p
        ref={paragraphRef}
        className="about-content font-[font6] mt-16 text-[2vh] text-center pl-12 text-zinc-800 leading-[3.5vh]"
      >
