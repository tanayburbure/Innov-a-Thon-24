  ...
  return (
    <div className="relative px-4 font-[font1] pt-1 pr-3">
      ...
      <div className="p-4 fixed z-50">
        <img className="w-[4vw] md:w-[8vw]" src="public/images/lobo.png" alt="Logo" />
      </div>
      ...
      <div className={`text-[#B3C8CF] tracking-wide text-[2.2vh] flex flex-col md:flex-row justify-end mr-44 pt-1 m-6 space-y-4 md:space-y-0 md:space-x-8 ${isMenuOpen ? 'block' : 'hidden'} md:block`}>
        <ul className="flex flex-col md:flex-row text-gray-400 font-bold space-y-4 md:space-y-0">
          {[
        ...
        <span className="whitespace-nowrap">
          <button className="px-3 -mt-[3px] overflow-hidden border-none bg-[#41B3A2] ml-4 py-1 pb-[0.5vh] text-black font-semibold rounded-full z-50">
