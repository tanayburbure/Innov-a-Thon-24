...
export default function MagneticGSAP({ children }) {
  ...
  useEffect(() => {
    ...
    const mouseMove = (e) => {
      ...
      const x = (clientX - (left + width / 2)) * 0.25; // Reduced magnetic effect by scaling down the x value by 50%
      const y = (clientY - (top + height / 2)) * 0.25; // Reduced magnetic effect by scaling down the y value by 50%
