    ...
    <div>
        <div className='relative h-[110vh] w-full overflow-hidden'>
            ...
            <div className='absolute inset-0 leading-normal flex flex-col '>
                <Navbar/>
                <h1 className='flex-grow tracking-tight mr-4 font-semibold text-[8.4vw] text-center mt-[17vh] text-[#41B3A2] font-[font1] transition-transform duration-300 cursor-pointer '>INNOV-A-THON'24 </h1>
                ...
                <h3 className='hover:animate-glitch p-12 absolute z-10 left-[36.4%] font-semibold tracking- font-[font1] top-32 text-[#B3C8CF] text-[3.2vh] '>
                  DATE:
                  22 nd December 2024
                </h3>
                <style jsx>{`
