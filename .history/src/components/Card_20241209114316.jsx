...
function Card() {
  return (
    <button className='bg-[#41B3A2] mt-12 mb-8 font-[font6] text-2xl py-[6px] px-8 rounded-full border-[#41B3A2] text-zinc-900 font-bold -top-8 hover:animate-glitch'>Register Now
