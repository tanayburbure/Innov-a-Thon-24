...
import {
  ...
  MDBInput,
  MDBRadio,
  MDBDropdown, // Changed from MDBSelect to MDBDropdown
  MDBDropdownToggle,
  MDBDropdownMenu,
  MDBDropdownItem
}
              ...
              <MDBCol md='6'>
                ...
                <MDBCardBody className='text-black d-flex flex-column justify-content-center'>
                  ...
                  <MDBRow>
                    ...
                    <MDBCol md='6'>
                      <MDBDropdown className='mb-4' size='lg'>
                        <MDBDropdownToggle>{'State'}</MDBDropdownToggle>
                        <MDBDropdownMenu>
                    ...
                    <MDBCol md='6'>
                      <MDBDropdown className='mb-4' size='lg'>
                        <MDBDropdownToggle>{'City'}</MDBDropdownToggle>
                        <MDBDropdownMenu>
                          <MDBDropdownItem>Option 1</MDBDropdownItem>
                          <MDBDropdownItem>Option 2</MDBDropdownItem>
                          <MDBDropdownItem>Option 3</MDBDropdownItem>
