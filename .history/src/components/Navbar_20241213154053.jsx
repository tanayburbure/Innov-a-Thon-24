        ...
        <div className="relative">
          ...
          {menuOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-50">
              <ul className="flex flex-col text-gray-400 font-bold">
                {[
                  { name: "About", scrollPercentage: 265 },
                  { name: "Prizes", scrollPercentage: 171 },
                  { name: "Sponsors", scrollPercentage: 353 },
                  ...
                  <li
                    key={index}
                    className="px-4 py-2 cursor-pointer hover:text-white hover:bg-gray-700 transition-colors duration-300"
                    onClick={() => {
