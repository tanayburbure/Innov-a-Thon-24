      ...
      <div className='text-[#B3C8CF] tracking-wide font-[font7] text-[2.1vh] flex justify-end mr-44 pt-1 m-6 space-x-8'>
          <ul className="flex text-gray-400 uppercase font-bold ">
            {[
              ...
              >
                <span className="terminal-effect">{item.name}</span>
                <span
        ...
        <style jsx>{`
          ...
          .terminal-effect {
            ...
            animation: typing 2s steps(10, end) forwards; /* Default typing effect */
          }
          ...
          li:hover .terminal-effect {
            animation: typing 2s steps(10, end) forwards, blink-caret .75s step-end infinite; /* Start typing effect on hover */
          }
        `}</style>
      </div>
    </div>
