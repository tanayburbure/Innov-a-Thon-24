...
function Feedback() {
  return (
    ...
    //   </div>
    // </div>
    <div className="h-[60vh] mt-16 text-white font-[font6] lg:h-[70vh] lg:mt-0">
      <div className="flex flex-col justify-center items-center gap-20 lg:flex lg:flex-col lg:items-between lg:justify-end">
        <h2 className="text-[7vw] lg:text-[3.5vw] font-bold mt-4 bg-gradient-to-r from-[#0D7C66] to-[#27DFB3] bg-clip-text text-transparent lg:w-[50%]">
          Send a Message
        </h2>
        <div className="w-[90vw] lg:w-[50%]">
          <form className="space-y-6">
            {/* Name Field */}
            <div>
