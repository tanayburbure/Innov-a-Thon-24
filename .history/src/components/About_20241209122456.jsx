...
function About() {
  ...
  return (
    <div className='text-white h-[75vh] mt-48 flex flex-col items-center'>
      ...
      <p className='about-content w-[68vw] mt-16 text-[2.4vh] text-center text-zinc-300 leading-[3.5vh]'>
