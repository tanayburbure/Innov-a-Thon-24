    ...
    <div className="wrapper overflow-x-hidden">
      <div className="flex lg:w-[260vw] h-[210vh] lg-h-[100vh]" ref={scrollContainerRef}>
        <div className="w-[100vw] h-screen flex items-center justify-center">
          <h1 className="pb-[88vh] lg:pt-40 lg:pl-[55.5vw] text-transparent bg-clip-text bg-gradient-to-t from-[#09a082] to-[#0D7C66] text-[10.5vw] lg:text-[8vw] -tracking-[2px] font-[font12] font-[600] mb-[2vh]">
            SCHEDULE
          </h1>
