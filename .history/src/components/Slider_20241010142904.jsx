...
const images = [
  { src: 'public/images/worker.png', title: 'MAGIC SLIDER', type: 'FLOWER', description: 'Lorem ipsum dolor sit amet...' },
  { src: 'public/images/high.jpg', title: 'MAGIC SLIDER', type: 'NATURE', description: 'Lorem ipsum dolor sit amet...' },
  { src: 'public/images/winner.png', title: 'MAGIC SLIDER', type: 'PLANT', description: 'Lorem ipsum dolor sit amet...' },
  ...
  return (
    <div className="relative w-full h-screen bg-black">
      <div className="slider relative h-full overflow-hidden flex justify-center items-center">
        ...
        {/* Navigation Arrows */}
        <div className="absolute top-[40%] right-16 transform -translate-y-1/2 z-10">
          <button
            onClick={prevSlide}
            className="text-white bg-green-500 p-3 rounded-full focus:outline-none hover:bg-white hover:text-black transition duration-300"
          >
            &lt;
          </button>
        </div>
