    ...
    <div className="relative px-4 font-[font1] pt-1 pr-3 bg-[#333]">
      ...
      <div className="fixed top-4 right-4 z-50 md:hidden">
        <span
          ...
          className="material-icons text-white bg-[#41B3A2] p-2 rounded cursor-pointer"
        >
      ...
      <div
        ...
        } md:flex text-[#B3C8CF] tracking-wide text-[2.2vh] justify-center items-center pt-1 m-6 space-x-8`}
      >
