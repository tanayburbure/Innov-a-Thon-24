      ...
      <div className="flex py-[3vh]">
        ...
        <div className="relative top-[9.8vh] left-[12vw] ">
          ...
          <a
              ...
              href="">
              <IoLogoInstagram className="relative z-10 group-hover:font-bold group-hover:text-[1.1rem]" />
            ...
            <a
              className="relative p-8 border-[1px] border-[#2A2929] rounded-full bg-[#2A2929] text-white overflow-hidden transition-all duration-300 group"
              href="">
              <FaLinkedinIn className="relative z-10 group-hover:font-bold group-hover:text-[2.5rem]" />
            ...
            <a
              className="relative p-8 border-[1px] border-[#2A2929] rounded-full bg-[#2A2929] text-white overflow-hidden transition-all duration-300 group"
              href="">
              <FaDiscord className="relative z-10 group-hover:font-bold group-hover:text-[2.5rem]" />
