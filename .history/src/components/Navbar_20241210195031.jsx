    ...
    <div className="relative px-4 font-[font1] pt-1 pr-3">
      ...
      <div className="fixed top-4 right-4 z-50 md:hidden">
        <button
          ...
          className="text-white bg-[#41B3A2] p-2 rounded"
        >
      ...
      <div
        ...
        } md:flex text-[#B3C8CF] tracking-wide text-[2.2vh] justify-end mr-44 pt-1 m-6 space-x-8`}
      >
        ...
        <span className="whitespace-nowrap mt-4 md:mt-0">
          <button className="px-3 -mt-[3px] overflow-hidden border-none bg-[#41B3A2]  py-1 pb-[0.5vh] text-black font-semibold rounded-full">
