...
function Timeline() {
  ...
  return (
    <div className="absolute flex flex-col items-center text-center z-50 pr-4">
      <h1 className="text-[#B3C8CF] font-[font1] text-[8vw] mt-36 lg:text-[5vh] lg:pl-[3.7vw]">
        HACKATHON BEGINS IN...
      </h1>
      <div className="text-black text-[7vw] mt-4 font-bold lg:text-[3vw] lg:pl-12">
        {timeLeft ? (
          <div className="flex font-bold font-[font1] space-x-3 items-center justify-center">
            <span className="w-[15vw] lg:w-[6.5vw] py-[0.5vh] lg:py-[0.3vh] rounded-2xl bg-[#41B3A2]">
