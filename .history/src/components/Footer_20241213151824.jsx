    ...
    <div className="h-[200vh] overflow-hidden">
      ...
      <div className=" py-[3vh]">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex text-[6vw] gap-8">
            <a
        ...
        <div className="flex flex-col items-center mt-12">
          ...
          <div className="text-zinc-400 font-[font6] flex text-[2.4vh] gap-[6px] mb-3">
            <FaMapLocationDot className="mt-[2px] text-[2.5vh] mr-1 text-[#0D7C66]" />
            <h3 className="text-[1.5vh]">
              AISSMS IOIT, <br /> Kennedy Rd, near RTO, Sangamvadi
              <br /> Pune, Maharashtra 411001
            </h3>
          </div>
          <div className="text-zinc-400 font-[font6] flex items-center gap-1 mr-[22vw]">
