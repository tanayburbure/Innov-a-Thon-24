...
function Footer() {
  return (
    ...
    //   </div>
    // </div>
    <div className="h-[78vh] lg:h-[50vh] overflow-hidden">
      {/* Divider Line */}
      ...
      {/* Footer Bottom Section */}
      <div>
        <div className="h-[1px] bg-[#2A2929]  relative bottom-3 lg:mx-16"></div>
        <div className="flex items-center font-[font1] text-[2.2vw] text-zinc-600 px-8 gap-4 lg:flex-row lg:justify-between lg:items-center lg:px-16">
          <h3 className="text-center lg:text-left">All Rights Reserved © 2024</h3>
          <button className="px-4 py-1 text-zinc-500 text-[2.3vw] border border-black rounded-full bg-transparent text-sm lg:text-[2.2vh] lg:text-zinc-500">
            contact developer
          </button>
