...
function About() {
  return (
    <div className='text-white h-[78vh] font-Blackpast mt-20 -mb-8 flex flex-col justify-center items-center '>
      
        <h3 className='absolute top-[57vw] text-center leading-[3.5vw] text-zinc-300 text-[4.5vh] font-regular  w-[60vw]'>
        <div><Card /> </div>
        <br />
                VENUE:
                <br />
        ...
        <h2 className='w-[65vw] mb-20  text-center text-md font-normal text-zinc-400 leading-7 '><span className='text-[7vw] text-zinc-400 tracking-tighter font-semibold'>About Us</span>
        <br />
        <br />
        <br />
