...
function Feedback() {
  return (
    ...
    //   </div>
    // </div>
    <div className="h-[65vh] mt-16 text-white font-[font6]">
      <div className="flex flex-col justify-center items-center gap-20">
        <h2 className="text-[5vw] font-bold mt-4 bg-gradient-to-r from-[#0D7C66] to-[#27DFB3] bg-clip-text text-transparent">
          Send a Message
        </h2>
        <div className="w-[70vw]">
          <form className="space-y-6">
            {/* Name Field */}
            <div>
              <label htmlFor="name" className="block text-[2vw] font-medium text-gray-600">
                Name
              </label>
              <input
                type="text"
            ...
            {/* Email Field */}
            <div>
              <label htmlFor="email" className="block text-[2vw] font-medium text-gray-600">
                Email
              </label>
              <input
                type="email"
            ...
            {/* Message Field */}
            <div>
              <label htmlFor="message" className="block text-[2vw] font-medium text-gray-600">
                Message
              </label>
              <textarea
                id="message"
            ...
            <button
              type="submit"
              className="bg-[#0D7C66] py-1 px- border-none rounded-md text-black font-bold "
            >
              Send
            </button>
          </form>
