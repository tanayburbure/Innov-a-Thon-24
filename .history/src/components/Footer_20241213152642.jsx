...
function Footer() {
  return (
    ...
    <div className="h-[200vh] overflow-hidden">
      {/* Divider Line */}
      <div className="h-[1px] bg-zinc-700 mx-2"></div>
      ...
      <div className=" py-[3vh]">
        ...
        <div className="flex flex-col items-center mt-12">
          <h2 className="font-[font15] text-zinc-400 text-[3vh] mb-8">
            ADDRESS
          </h2>
      ...
      {/* Footer Bottom Section */}
      <div className="h-[1px] bg-zinc-900 mt-8 mx-2"></div>
      <div className="flex justify-between text-[1vh] mt-4 items-center font-[font1] text-zinc-600 px-2">
        <h3 className='w-[25vw]'>All Rights Reserved © 2024</h3>
        <button className="px-4 border border-black rounded-full">
          contact developer
        </button>
        <h3 className='w-[25vw]'>WEBSITE BY TESA TECH TEAM</h3>
      </div>
    </div>
  );
}
