  ...
  return (
    <div className='h-[100vh] flex px-20  w-full '>
        <div className='relative w-1/2'>
            <img src="public/images/winner.png" alt="" className='absolute w-[80%] pl-12 top-56 h-48 object-cover brightness-[50%] blur-[4px]'/>
            <div className='relative pl-16 py-2'>
                <h1 className='text-[7vw] font-bold tracking-tight text-[#0D7C66]'>Our Past</h1>
        ...
        <div className='w-1/2 relative mt-4'>
            <div className='flex flex-wrap justify-center'>
                <img src="public/images/team.jpg" alt="" className='w-[50%] h-[30vh] border-[1px] rounded-xl border-[#0D7C66] absolute top-[32vh] -left-4'/>
                <img src="public/images/team.jpg" alt="" className='w-[46%] h-[28vh] border-[1px] rounded-xl border-[#0D7C66] absolute top-4 right-12 '/>
                <img src="public/images/team.jpg" alt="" className='w-[52%] h-auto border-[1px] rounded-xl border-[#0D7C66] absolute  top-56 -right-12'/>
                <img src="public/images/team.jpg" alt="" className='w-[52%] h-auto border-[1px] rounded-xl border-[#0D7C66] absolute top-0 -left-16'/>
            </div>
        </div>
    </div>
  )
