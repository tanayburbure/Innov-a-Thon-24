...
function About() {
  return (
    <div className='text-white h-[78vh]  mt-20 -mb-8 flex flex-col justify-center items-center '>
        ...
        <h2 className='w-[65vw]  font-regular font-[font6] tracking-light text-center text-[2.5vh] font-[100] text-zinc-400 leading-[3.5vh] '><span className='text-[7vw] font-[font1] text-zinc-300 tracking-light font-semibold'>About <span className='text-[#0D7C66] tracking-tighter'>Us</span></span>
        <br />
        <br />
        <br />
