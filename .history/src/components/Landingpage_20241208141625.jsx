    ...
    <div>
        <div className='relative h-[110vh] w-full overflow-hidden'>
            ...
            <div className='absolute inset-0 leading-normal flex flex-col '>
                <Navbar/>
                <h1 className='flex-grow tracking-tight mr-4 font-semibold text-[8.4vw] text-center mt-[17vh] bg-[#0D7C66] to-green-100 text-transparent bg-clip-text font-[font1] animate-jessica'>INNOV-A-THON'24 </h1>
                ...
                <style jsx>{`
                  @keyframes jessica {
                    0% { text-shadow: 2px 2px 0 rgba(255, 0, 0, 0.7); }
                    20% { text-shadow: -2px -2px 0 rgba(0, 255, 0, 0.7); }
                    40% { text-shadow: 2px 2px 0 rgba(255, 0, 0, 0.7); }
                    60% { text-shadow: -2px -2px 0 rgba(0, 255, 0, 0.7); }
                    100% { text-shadow: 2px 2px 0 rgba(255, 0, 0, 0.7); }
                  }
                  .animate-jessica {
                    animation: jessica 1s infinite;
                  }
                `}</style>
