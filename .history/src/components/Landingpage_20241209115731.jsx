...
export const Landingpage = () => {
  ...
  const h3Ref = useRef(null); // Reference for h3
  const h4Ref = useRef(null); // Reference for h4
  ...
  useEffect(() => {
    // GSAP animation for h3 and h4 with modern effects
    gsap.from(h3Ref.current, { opacity: 0, y: -30, duration: 1, ease: "power2.out" });
    gsap.from(h4Ref.current, { opacity: 0, y: 30, duration: 1, ease: "power2.out", delay: 0.2 });
  }, []);
    ...
    <div>
        <div className='relative h-[110vh] w-full overflow-hidden'>
            ...
            <div className='absolute inset-0 leading-normal flex flex-col '>
                ...
                <h4 ref={h4Ref} className='text-transparent text-[2.8vh] font-light tracking-tight text-center ml-[40vw] mb-[65vh] bg-gradient-to-r from-green-900 to-green-100 bg-clip-text font-[font11]'>Igniting Innovation, Fueling the Future</h4>
                <h3 ref={h3Ref} className='p-12 absolute animate-glitch z-10 left-[36.4%] font-semibold tracking- font-[font1] top-32 text-[#B3C8CF] text-[3.2vh] '>
                  DATE:
                  22 nd December 2024
                </h3>
                <style jsx>{`
