  ...
  return (
    <div className="relative w-full h-screen bg-black">
      <div className="slider relative h-full overflow-hidden flex justify-center items-center">
        ...
        <div className="absolute top-[40%] right-8 transform -translate-y-1/2 z-10">
          <button
            onClick={nextSlide}
            className="text-white bg-green-500 px-[3vh] py-4 rounded-full focus:outline-none hover:bg-white hover:text-black transition duration-300"
          >
            &gt;
          </button>
        </div>
