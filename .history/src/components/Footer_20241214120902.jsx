...
function Footer() {
  return (
    ...
    <div className="h-[78vh] overflow-hidden">
      ...
      <div className=" py-[3vh] lg:flex lg:justify-between lg:items-center lg:ml-20">
        {/* Logo Section */}
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex text-[5.5vw] gap-8">
            <a
              className="relative lg:bg-[#2A2929] text-white"
              href=""
            >
              <IoLogoInstagram className="relative z-10" />
              <span className=""></span>
        ...
        {/* Address Section */}
        <div className="flex flex-col items-center mt-12 lg:mt-0 lg:pr-12">
