    ...
    <div className='relative'>
      ...
      <div className='text-white flex justify-end mr-36 m-4 space-x-8'>
        ...
        <span className="overflow-hidden">
          <button className='relative px-4 py-1 bg-[#0D7C66] text-black font-semibold rounded-full z-50 fixed'>
            <span className="inline-block animate-marquee whitespace-nowrap absolute left-0">
              Register here
            </span>
          </button>
        </span>
