...
const Past = () => {
  ...
  return (
    ...
    <div className="h-[110vh] font-[font1] w-full flex flex-col ">
      ...
      {/* Right Section with Images */}
      <div className="relative mt-16 lg:w-[40%]">
        <div className="flex flex-wrap justify-center items-center">
          {[
            { top: "2vh", left: "7vw", size: "40%", height: "13vh", lg: { top: "27vh", left: "3.8vw", size: "40%", height: "2wvh" } },
            { top: "16vh", right: "6vh", size: "34%", height: "12vh", lg: { top: "8.3vh", right: "12vh", size: "34%", height: "21vh" } },
            { top: "3vh", right: "4vh", size: "38%", height: "11vh", lg: { top: "30.5vh", right: "10.5vh", size: "38%", height: "24vh" } },
            { top: "17vh", left: "6vh", size: "34%", height: "auto", lg: { top: "5.5vh", left: "15.1vh", size: "34%", height: "auto" } },
          ].map((image, index) => (
            <img
              key={index}
              src="public/images/team.png"
