    ...
    <div>
        <div className='relative h-[110vh] w-full overflow-hidden'>
            ...
            <div className='absolute inset-0 leading-normal flex flex-col '>
                ...
                <h4 ref={subtitleRef} className='text-transparent text-[2.8vh] font-light tracking-tight  text-center ml-[40vw] -mt-[20vh] bg-gradient-to-r from-green-900 to-green-100 bg-clip-text font-[font11] opacity-0'>Igniting Innovation, Fueling the Future</h4>
