  ...
  const images = [
    {
      ...
      size: "40%",
      height: "13vh",
      lg: { top: "0vh", right: "26vw", size: "80%", height: "23vh" },
    },
    {
      top: "16vh",
      right: "6vh",
      size: "34%",
      height: "12vh",
      lg: { top: "8.3vh", right: "12vh", size: "75%", height: "21vh" },
    },
    {
      top: "3vh",
      right: "4vh",
      size: "38%",
      height: "11vh",
      lg: { top: "30.5vh", right: "10.5vh", size: "70%", height: "24vh" },
    },
    {
      top: "17vh",
      left: "6vh",
      size: "34%",
      height: "auto",
      lg: { top: "5.5vh", left: "15.1vh", size: "65%", height: "auto" },
    },
  ];
    ...
    <div className="h-[110vh] font-[font1] w-full flex flex-col ">
      ...
      <div className="lg:flex lg:justify-between lg:mt-8">
        ...
        <div className="">
          ...
          <p
            ref={paragraphRef}
            className="mt-12 w-[85%] font-[font6] text-zinc-800 text-[1.6vh] lg:text-[2.5vh] font-light leading-7 lg:w-[55%] lg:pl-28 "
          >
