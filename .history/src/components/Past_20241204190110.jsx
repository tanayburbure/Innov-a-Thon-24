    ...
    <div className='h-[100vh] flex px-20  w-full '>
        ...
        <div className='w-1/2 relative mt-4'>
            <div className='flex flex-wrap justify-center '>
                ...
                <img src="public/images/team.png" alt="" className='w-[46%] h-[28vh] border-[1px]  border-[#0D7C66] absolute top-4 right-12 '/>
                <img src="public/images/team.png" alt="" className='w-[52%] h-auto border-[1px]  border-[#0D7C66] absolute  top-56 -right-12'/>
