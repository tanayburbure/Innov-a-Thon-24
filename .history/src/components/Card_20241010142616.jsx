  ...
  return (
    <div className=' w-full  flex mt-8 justify-center'>
      <div className='w-[30vw] h-[36vh]'>
        <div className="relative flex flex-col justify-between items-center w-full h-full shadow-md rounded-xl relative bg-[#27DFB3] bg-cover bg-center" style={{ backgroundImage: "url('public/images/worker.png')", filter: "brightness(70%)" }}>
          {/* Content */}
