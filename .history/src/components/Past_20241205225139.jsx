...
function Past() {
  return (
    <div className='h-[88vh] mt-12 flex px-16  w-full '>
        <div className='relative w-1/2'>
            ...
            <div className='relative pl-16 py-2'>
                <h1 className='text-[7.5vw] tracking-tighter text-zinc-200 font-semibold tracking-tight '>OUR <span className='text-[#0D7C66] text-[7.5vw] pl-4'>PAST</span></h1>
