    ...
    <div className="wrapper overflow-x-hidden">
      <div className="flex w-[270vw] h-screen" ref={scrollContainerRef}>
        <div className="w-[200vw] h-screen flex items-center">
          <h1 className="absolute text-transparent bg-clip-text tracking-tight bg-gradient-to-t from-[#09a082] to-[#0D7C66] top-12 left-[62.7vw] text-[6.8vw] font-[font7] font-[600] mb-[2vh]">
            SCHEDULE
          </h1>
