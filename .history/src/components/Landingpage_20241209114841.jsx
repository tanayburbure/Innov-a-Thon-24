...
export const Landingpage = () => {
  ...
  useEffect(() => {
    ...
    // GSAP animations for texts
    gsap.from(titleRef.current, { duration: 1, y: -50, opacity: 0, ease: "power2.out" });
    ...
    <div>
        <div className='relative h-[110vh] w-full overflow-hidden'>
            ...
            <div className='absolute inset-0 leading-normal flex flex-col '>
                <Navbar/>
                <h1 ref={titleRef} className='flex-grow opacity-2 tracking-tight mr-4 font-semibold text-[8.4vw] text-center mt-[17vh] text-[#41B3A2] font-[font1] transition-transform '>INNOV-A-THON'24 </h1>
                <h4 ref={subtitleRef} className='text-transparent text-[2.8vh] font-light tracking-tight  text-center ml-[40vw] mb-[65vh] bg-gradient-to-r from-green-900 to-green-100 bg-clip-text font-[font11]'>Igniting Innovation, Fueling the Future</h4>
                <h3 ref={dateRef} className='p-12 absolute  animate-glitch z-10 left-[36.4%] font-semibold tracking- font-[font1] top-32 text-[#B3C8CF] text-[3.2vh] '>
                  DATE:
                  22 nd December 2024
                </h3>
                <style jsx>{`
