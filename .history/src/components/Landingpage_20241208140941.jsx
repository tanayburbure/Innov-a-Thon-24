    ...
    <div>
        <div className='relative h-[110vh] w-full overflow-hidden'>
            ...
            <div className='absolute inset-0 leading-normal flex flex-col '>
                <Navbar/>
                <h1 className='flex-grow tracking-tight mr-4 font-semibold text-[8.4vw] text-center mt-[17vh] bg-[#0D7C66] to-green-100 text-transparent bg-clip-text font-[font1] terminal-effect'>INNOV-A-THON'24 </h1>
                ...
                <style jsx>{`
                  ...
                  @keyframes terminal {
                    ...
                    50% { border-right: 2px solid #0D7C66; }
                    100% { border-right: 2px solid transparent; }
                  }
                  .terminal-effect {
                    border-right: 2px solid #0D7C66;
