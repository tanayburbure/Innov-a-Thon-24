    ...
    <div className="relative px-4 font-[font1] pt-1 pr-3 bg-[#333]">
      ...
      > 
        ...
        <span className="whitespace-nowrap md:hidden">
          <button className=" overflow-hidden border-none bg-[#41B3A2] text-black font-semibold rounded-full">
            <span className="inline-block animate-marquee font-[font4] py-[0.5px] text-[2.3vh]">
              Register Here
            </span>
          </button>
        </span>
