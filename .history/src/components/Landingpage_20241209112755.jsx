    ...
    <div>
        <div className='relative h-[110vh] w-full overflow-hidden'>
            ...
            <div className='absolute inset-0 leading-normal flex flex-col '>
                <Navbar/>
                <h1 className='flex-grow tracking-tight mr-4 font-semibold text-[8.4vw] text-center mt-[17vh] text-[#41B3A2] font-[font1] transition-transform cursor-pointer animate-glitch'>INNOV-A-THON'24 </h1>
