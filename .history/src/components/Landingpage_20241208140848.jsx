    ...
    <div>
        <div className='relative h-[110vh] w-full overflow-hidden'>
            ...
            <div className='absolute inset-0 leading-normal flex flex-col '>
                <Navbar/>
                <svg className='flex-grow tracking-tight mr-4 font-semibold text-[8.4vw] text-center mt-[17vh] bg-[#0D7C66] to-green-100 text-transparent bg-clip-text font-[font1]' viewBox="0 0 800 200">
                  <text x="50%" y="50%" textAnchor="middle" dominantBaseline="middle" fill="url(#gradient)" fontSize="8.4vw" fontWeight="bold">
                    INNOV-A-THON'24
                  </text>
                  <defs>
