...
const Navbar = () => {
  ...
  return (
    <div className='relative px-4 pt-1 pr-3'>
      ...
      <div className='text-[#B3C8CF] tracking-wide  text-[2.1vh] flex justify-end mr-44 pt-1 m-6 space-x-8'>
          <ul className="flex text-gray-400 uppercase font-bold ">
            {[
              ...
              >
                {item.name}
                <span
                  className="absolute bottom-0 left-1 font-[font11] w-[90%] h-[2px] bg-[#006A67] scale-x-0 origin-left transition-transform duration-400 group-hover:scale-x-100"
                ></span>
              </li>
            ))}
          </ul>
