    ...
    <div className=" h-[32vw] w-full overflow-hidden">
      ...
      <div className="flex py-[3vh]">
        ...
        <div className="relative top-[9.8vh] left-[12vw] ">
          ...
          <a
              id="lobo"
              className="relative p-8 border-[1px] border-[#2A2929] rounded-full bg-[#2A2929] text-white overflow-hidden transition-all duration-300 group hover:cursor-pointer hover:opacity-100 hover:font-bolder hover:text-[rgb(36,226,226)] hover:text-[1.8vw]"
              href="">
