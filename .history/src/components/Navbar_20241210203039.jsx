...
const Navbar = () => {
  ...
  return (
    <div className={`relative px-4 font-[font1] pt-1 pr-3 bg-[#333] ${isMenuOpen ? 'backdrop-blur-md' : ''}`}>
      {/* Logo */}
      ...
      <div className="fixed absolute top-4 right-4 z-50 md:hidden">
        <span
          ...
          className={`text-white bg-[#41B3A2] rounded cursor-pointer ${isMenuOpen ? 'invisible' : ''}`}
        >
      ...
      > 
        ...
        <span className="md:hidden ">
          <button className="overflow-hidden flex items-center py-[1vh] justify-center border-none bg-[#41B3A2] text-black font-semibold rounded-full px-4">
            <span className="inline-block animate-marquee font-[font4] text-[2.4vh] -py-4">
              Register Here
            </span>
          </button>
        </span>

        <ul className="flex flex-col md:flex-row mt-12 text-gray-400 font-bold">
          {[
