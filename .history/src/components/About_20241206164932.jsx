...
function About() {
  return (
    <div className='text-white h-[78vh]  mt-20 -mb-8 flex flex-col justify-center items-center '>
        ...
        <h2 className='w-[65vw] mb-20  text-center text-md font-normal text-zinc-400 leading-7 '><span className='text-[7vw] font-[Black] text-zinc-400 tracking-tighter font-semibold'>About Us</span>
        <br />
        <br />
        <br />
