  ...
  return (
    <div>
      <div className="relative h-[110vh] w-full overflow-hidden">
        ...
        {/* Overlay Content */}
        <div className="absolute inset-0 mt-20 flex flex-col leading-normal">
          <Navbar />

          {/* Main Heading */}
          <h1 className="flex-grow  tracking-tight font-semibold text-[12vw] text-center mt-[17vh] text-[#0D7C66] font-[font1] transition-transform sm:text-[6vw]">
            INNOV-A-THON'24
          </h1>

          {/* Tagline */}
          <h4 className="text-transparent absolute top-[52vh] right-[15%] text-[2.8vh] font-light tracking-tight text-center bg-gradient-to-r from-[#0D7C66] to-green-300 bg-clip-text font-[font1]">
            Igniting Innovation, Fueling the Future
          </h4>

          {/* Date */}
          <h3 className="p-12 w-[80%] absolute animate-glitch left-[10.4%] font-semibold text-[#B3C8CF] text-[1.8vh] top-32 font-[font1]">
