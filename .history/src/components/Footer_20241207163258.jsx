    ...
    <div className=" h-[32vw] w-full overflow-hidden">
      ...
      <div className="flex py-[3vh]">
        ...
        <div className="relative top-[9.8vh] left-[12vw] ">
          ...
          <a
              className="relative p-8  border-[1px] border-[#2A2929] hover:scale-150 rounded-full bg-[#2A2929] text-white overflow-hidden transition-all duration-300 group"
              href="">
              <IoLogoInstagram className="relative z-10 hover:scale-150" />
