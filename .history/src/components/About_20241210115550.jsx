...
function About() {
  ...
  return (
    <div className="text-white h-[70vh] mt-48 flex flex-col items-center">
      <h1 className="w-[68vw] mb-4 text-center font-light text-zinc-400 leading-[3.5vh]">
        <span className="text-[7.5vw] font-semibold text-zinc-300">
          About <span className="text-[#0D7C66]">Us</span>
        </span>
      </h1>
      <p
        ref={paragraphRef}
        className="font-[font6] w-[68vw] mt-16 text-[2.5vh] text-center text-zinc-800 leading-[3.5vh]"
      >
