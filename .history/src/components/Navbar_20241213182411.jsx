...
const Navbar = () => {
  ...
  return (
    ...
    <div className="flex w-[70vw]  justify-between font-[font1] pt-1 pr-3">
      ...
      {/* Navigation Links */}
      <div className="relative left-[60vw] text-[#B3C8CF] tracking-wide z-50 text-[2.2vh] flex justify-end  pt-1 m-6 space-x-8">
        <div className="">
        ...
        <div>
          {/* Register Button */}
        <span className="relative top-20 whitespace-nowrap ">
          <button className="border-none bg-[#41B3A2] overflow-hidden pb-[0.5vh] text-black font-semibold rounded-full z-50 fixed">
