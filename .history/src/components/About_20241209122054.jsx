...
function About() {
  ...
  return (
    <div className='text-white h-[78vh] mt-36 flex flex-col items-center'>
      <h2 className='w-[68vw] mb-4 font-[font6] tracking-light text-center font-[100] text-zinc-400 leading-[3.5vh]'>
        <span className='text-[8vw] font-[font1] text-zinc-300 tracking-light font-semibold'>About <span className='text-[#0D7C66] tracking-tighter'>Us</span></span>
      </h2>
