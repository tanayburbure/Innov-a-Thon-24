...
function About() {
  ...
  return (
    <div className='h-[70vh] mt-48 flex flex-col items-center'>
      ...
      >
        About <span className='text-[import React, { useEffect, useRef } from 'react';
import gsap from 'gsap';
import { ScrollTrigger } from 'gsap/ScrollTrigger';
...
function About() {
  ...
  return (
    <div className='text-white h-[70vh] mt-48 flex flex-col items-center'>
      <h1
        ref={headingRef}
        className='w-[68vw] mb-4 tracking-light text-center font-[100] text-zinc-400 leading-[3.5vh]'
      >
