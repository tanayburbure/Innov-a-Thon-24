  ...
  return (
    <div className='h-[100vh] mt-[28vw] flex text-white items-center flex-col w-full'>
        ...
        <div className='flex justify-between items-center mt-20 w-full'>
          <video className='h-[15vh] w-auto' controls autoPlay>
            <source src="public\video\Animation - 1733388438706.gif" type="video/mp4" />
          ...
          <video className='h-[15vh] w-auto' controls>
            <source src="public\video\Animation - 1733388438706.gif" type="video/mp4" />
            Your browser does not support the video tag.
          </video>
        </div>
