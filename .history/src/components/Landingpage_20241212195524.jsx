    ...
    <div>
      <div className="relative h-[110vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col leading-normal">
          ...
          {/* Tagline */}
          <h4 className="text-transparent absolute top-[44vh] text-[2vh] font-light tracking-tight text-center bg-gradient-to-r from-[#0D7C66] to-green-300 bg-clip-text font-[font1]">
