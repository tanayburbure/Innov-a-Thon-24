...
const Navbar = () => {
  ...
  return (
    <nav className="flex w-[70vw] justify-between font-[font1] pt-1 pr-3 lg:px-2">
      {/* Logo */}
      ...
      {/* Register Button */}
      <div>
        <span className="relative top-4 -right-8 whitespace-nowrap lg:left-[18vw] lg:top-5 md:left-[12vw]">
          <Link to="./Registration" className="border-none bg-[#41B3A2] overflow-hidden pb-[0.5vh] text-black font-semibold rounded-full z-[99999] fixed">
