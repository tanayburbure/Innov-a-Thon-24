...
const Schedule = () => {
  ...
  useEffect(() => {
    ...
    const scrollTriggerInstance = gsap.to(scrollContainerRef.current, {
      xPercent: -22, // Scroll through 200% width (for 3 pages)
      ease: "none",
      scrollTrigger: {
    ...
    <div className="wrapper overflow-x-hidden">
      <div className="flex w-[270vw] h-screen" ref={scrollContainerRef}>
        <div className="w-[200vw] h-screen flex items-center">
          <h1 className="absolute text-transparent bg-clip-text bg-gradient-to-t from-[#09a082] to-[#0D7C66] top-12 left-[61.8vw] text-[7.5vw] -tracking-[2px] font-[font1] font-[600] mb-[2vh]">
            SCHEDULE
          </h1>
