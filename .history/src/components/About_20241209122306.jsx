...
function About() {
  ...
  return (
    <div className='text-white h-[78vh] mt-36 flex flex-col items-center'>
      <h1 className='w-[68vw] mb-4  font-[font6] tracking-light text-center font-[100] text-zinc-400 leading-[3.5vh]'>
      ...
      <p className='about-content w-[68vw] mt-16 text-[2.4vh] text-center text-zinc-400 leading-[3.5vh]'>
