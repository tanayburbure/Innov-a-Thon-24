            ...
            <div className="flex space-x-8 ml-[100vw] mt-16 gap-[4vw] w-[170vw] ">
              {[
                ...
                <div className="text-white text-center" key={index}>
                  ...
                  <div className={`card w-[19vw] h-[22vh] bg-gray-800 rounded-lg shadow-lg mt-2 opacity-0 translate-x-4 transition-opacity duration-500 ease-in-out ${index % 2 === 0 ? 'translate-x-[-20px]' : 'translate-x-[20px]'}`}>
