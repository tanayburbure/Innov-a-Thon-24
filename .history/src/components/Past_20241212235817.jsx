...
const Past = () => {
  ...
  return (
    ...
    //   </div>
    // </div>
    <div className="h-[88vh] font-[font1] w-full">
      {/* Left Section */}
      <div className="f">
      ...
      <div className="relative mt-16">
        <div className="flex flex-wrap justify-center">
          {[
            { top: "2vh", left: "3.8vw", size: "40%", height: "13vh" },
            { top: "8.3vh", right: "12vh", size: "34%", height: "12vh" },
            { top: "30.5vh", right: "10.5vh", size: "38%", height: "10vh" },
            { top: "5.5vh", left: "15.1vh", size: "34%", height: "auto" },
          ].map((image, index) => (
            <img
              key={index}
