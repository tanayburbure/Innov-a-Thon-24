...
function Feedback() {
  return (
    ...
    //   </div>
    // </div>
    <div className="h-[60vh] mt-16 text-white font-[font6]">
          ...
          <form className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                name="message"
                rows="3"
                className="mt-1 py-1 w-full rounded-md border-gray-300 shadow-xs bg-[#C4DAD2] focus:ring-indigo-500 focus:border-indigo-500 pl-2"
                placeholder="Your Message"
              />
            </div>
            {/* Submit Button */}
