        ...
        {timeLeft ? (
          <div className="flex font-bold font-[font1] space-x-3 items-center justify-center">
            <span className="w-[15vw] py-[0.8vh] rounded-2xl bg-[#41B3A2]">
              {timeLeft.days} <span className="text-[4vw]">D</span>
            </span>
            <span className="w-[15vw] py-[0.8vh] rounded-2xl bg-[#41B3A2]">
              {timeLeft.hours} <span className="text-[4vw]">H</span>
            </span>
            <span className="w-[15vw] py-[0.8vh] rounded-2xl bg-[#41B3A2]">
              {timeLeft.minutes} <span className="text-[4vw]">M</span>
            </span>
            <span className="w-[15vw] py-[0.8vh] rounded-2xl bg-[#41B3A2]">
              {timeLeft.seconds} <span className="text-[4vw]">S</span>
            </span>
          </div>
        ) : (
