...
export const Landingpage = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const scaleValue = 1 + scrollPosition / 2000; // Adjust scale based on scroll position
    ...
    <div>
        <div className='relative h-[110vh] w-full overflow-hidden'>
            ...
            <div className='absolute inset-0 leading-normal flex flex-col '>
                ...
                <h3 className='p-12 absolute left-[36.4%] font-semibold tracking- font-[font1] top-32 text-[#B3C8CF] text-[3.2vh]'>
                  DATE:
