    ...
    <div>
      <div className="relative h-[100vh] w-full overflow-hidden lg:h-[110vh]">
        ...
        <div className="absolute inset-0 flex flex-col leading-normal">
          ...
          <div className='mt-8'>
            {/* Main Heading */}
          <h1 className="absolute flex-grow tracking-tight font-semibold text-[13vw] text-center mt-[20vh] text-[#0D7C66] font-[font1] transition-transform lg:text-[8.5vw] lg:mt-20 ">
            INNOV-A-THON'24
          </h1>
