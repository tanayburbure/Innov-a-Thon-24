...
const Schedule = () => {
  ...
  return (
    ...
    // </div>
    <div className="wrapper overflow-x-hidden">
      <div className="flex lg:w-[270vw] h-[210vh] lg-h-[100vh]" ref={scrollContainerRef}>
        <div className="w-[100vw] h-screen flex items-center justify-center">
          <h1 className="pb-[88vh] text-transparent bg-clip-text bg-gradient-to-t from-[#09a082] to-[#0D7C66] text-[10.5vw] -tracking-[2px] font-[font1] font-[600] mb-[2vh]">
            SCHEDULE
          </h1>
          <div className="absolute mt-[105vh] lg:mt-[38vh] flex flex-col items-center">
            <div className="mt-[1vh] lg:ml-[100vw] lg:mt-[7vh] lg:gap-[3.5vw] lg:w-[170vw] lg:flex lg:justify-center">
              {[
                { time: "10:00 AM", title: "Opening Ceremony" },
                { time: "11:00 AM", title: "Keynote Speaker" },
                { time: "12:00 PM", title: "Workshop 1: Innovation in Tech" },
                ...
                <div className="text-white text-center" key={index}>
                  ...
                  <div  className={`card w-[35vw] h-[22vh] bg-gray-800 rounded-lg shadow-lg mt-2 opacity-1 `}>
                    <p className="p-2 text-center">{event.title}</p>
                    <p className="p-2 text-center">Details about the event</p>
                  </div>
                </div>
