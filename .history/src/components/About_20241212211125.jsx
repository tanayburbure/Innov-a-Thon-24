...
function About() {
  ...
  return (
    <div className="text-white h-[70vh] mt-32 flex flex-col items-center">
      ...
      <p
        ref={paragraphRef}
        className="about-content font-[font6] w-[68vw] mt-16 text-[2vh] text-center text-zinc-800 leading-[3.5vh]"
      >
