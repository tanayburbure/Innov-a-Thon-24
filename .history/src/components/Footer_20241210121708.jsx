        ...
        <div className="relative top-[9.8vh] left-[12.3vw]">
          ...
          <div className="flex text-[1.5vw]  gap-8">
            ...
            >
              ...
              <span className="absolute -inset-1 bg-blue-500 transform overflow-hidden translate-y-full group-hover:translate-y-0 transition-transform duration-300 z-0"></span>
            </a>
            <a
              className="relative p-8 border-[1px] border-[#2A2929] hover:scale-110 rounded-full bg-[#2A2929] text-white transition-all duration-300 group"
              href=""
            >
