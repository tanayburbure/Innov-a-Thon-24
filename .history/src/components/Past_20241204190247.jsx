    ...
    <div className='h-[100vh] flex px-20  w-full '>
        <div className='relative w-1/2'>
            ...
            <div className='relative pl-16 py-2'>
                <h1 className='text-[5vw] tracking-tighter text-zinc-200 font-bold tracking-tight '>OUR <span className='text-[#0D7C66] text-[7vw] pl-4'>PAST</span></h1>
        ...
        <div className='w-1/2 relative mt-4'>
            <div className='flex flex-wrap justify-center '>
                <img src="public/images/team.png" alt="" className='w-[50%] h-[28vh] border-[1px]  border-[#0D7C66] absolute top-[34vh] -left-4'/>
                <img src="public/images/team.png" alt="" className='w-[46%] h-[27vh] border-[1px]  border-[#0D7C66] absolute top-8 right-12 '/>
                <img src="public/images/team.png" alt="" className='w-[45%] h-[27vh] border-[1px]  border-[#0D7C66] absolute  top-56 -right-12'/>
                <img src="public/images/team.png" alt="" className='w-[52%] h-auto border-[1px]  border-[#0D7C66] absolute top-0 -left-16'/>
            </div>
        </div>
    </div>
  )
