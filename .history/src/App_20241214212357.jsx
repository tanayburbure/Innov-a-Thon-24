  ...
  return (
    <div className="select-none overflow-hidden">
      ...
      <div className="fixed bottom-5 right-5  z-50">
        <button
          onClick={toggleMusic}
          className={`bg-transparent font-[font7] writing-vertical-rl text-center hover:text-none border-none shadow-none hover:shadow-none !hover:bg-transparent focus:outline-none ${isMusicPlaying ? 'text-[#41B3A2]' : 'text-yellow-500'
            }`}
          style={{
