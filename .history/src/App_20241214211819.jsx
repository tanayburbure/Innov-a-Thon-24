  ...
  return (
    <div className="select-none overflow-hidden">
      ...
      <div className="fixed bottom-5 left-5 z-50">
        <button
          onClick={toggleMusic}
          className={`bg-transparent font-[font7] hover:text-default border-none shadow-none hover:shadow-none !hover:bg-transparent focus:outline-none ${isMusicPlaying ? 'text-[#41B3A2]' : 'text-yellow-500'
            }`}
        >
