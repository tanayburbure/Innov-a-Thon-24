...
function App() {
  ...
  <button
    onClick={toggleMusic}
    className="bg-transparent font-[font7] text-white border-none shadow-none hover:shadow-none !hover:bg-transparent hover:text-white !hover:text-white !hover:border-none focus:outline-none "
  >
